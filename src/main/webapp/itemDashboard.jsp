...
<% if (message != null) { %>
    <div id="notification" 
         class="alert <%= message.contains("successfully") ? "alert-success" : "alert-danger" %> text-center position-fixed top-0 start-50 translate-middle-x shadow" 
         style="z-index: 1055; width: 50%; margin-top: 70px;">
        <%= message %>
    </div>
<% } %>
    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
            <ul class="navbar-nav">
                ...
                <li class="nav-item"><a class="nav-link active" href="customerControl.jsp">Items Control</a></li>
...
<div class="container-fluid py-5 item-dashboard-bg">
    <div class="page-header">
        <h3 class="mb-4 text-primary fw-bold text-center">Item Control Dashboard</h3>
    </div>
    <div class="row g-4">
        <!-- Item Table Section -->
